...
export default function Home() {
  return (
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-30 flex flex-col items-center justify-center text-center">
        <div className="mx-auto mb-4 flex max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border border-gray-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all hover:border-gray-300 hover:bg-white/50">
          <p className="text-sm font-semibold text-gray-700">
            DocInsight is now public!
          </p>
        </div>

        <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl">
          Insights from your{" "}
          <span className="bg-gradient-to-r from-blue-400 via-blue-200 to-blue-800 bg-clip-text text-7xl text-transparent">
            documents
          </span>{" "}
          in seconds.
        </h1>
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-xl">
          {" "}
          DocInsight allows you to have conversions, while extracting insights
      ...
      <div className="mx-auto mb-32 mt-20 max-w-5xl sm:mt-36">
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4 ">
              <span className="text-smb font-medium text-blue-600">Step 1</span>
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4 ">
              <span className="text-smb font-medium text-blue-600">Step 2</span>
              <span className="text-xl font-semibold">
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4 ">
              <span className="text-smb font-medium text-blue-600">Step 3</span>
              <span className="text-xl font-semibold">
                Start extracting insights.
              </span>
              <span className="mt-2 text-zinc-700">
                Begin chatting, asking questions to gain insights from your PDF.
              </span>
            </div>
          </li>
        </ol>
